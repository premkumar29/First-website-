...
<head>
  ...
  <title>TinDog</title>
  <!-- font-awesome -->
  <script src="https://kit.fontawesome.com/86698e3bd2.js" crossorigin="anonymous"></script>
    <!-- googlefonts -->
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <button type="button" class="btn btn-outline-dark btn-lg download-button btn-light"><i class="fab fa-google-play"></i> Download</button>
        </div>
  ...
  <section id="features">
    <div class="row">
      ...
      <div class="features-box col-lg-4">
        <i class=" icon fas fa-dog fa-4x"></i>
  ...
  <section id="cta">
    ...
    <h3 class="footer-head">Find the True Love of Your Dog's Life Today.</h3>
      <button type="button" class=" download-button btn btn-lg btn-dark"><i class="fab fa-apple"></i> Download</button>
      <button type="button" class=" download-button btn btn-lg btn-outline-dark btn-light"><i class="fab fa-google-play"></i> Download</button>
